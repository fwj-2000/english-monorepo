      ...
      <section className='mt-20'>
        ...
        <div className='grid grid-cols-3 gap-4'>
          {steps.map((step, i) => (
            <div
              key={step.title}
              className='relative bg-white rounded-xl border border-gray-200 p-6 text-center'
            >
      ...
      <section className='mt-20'>
        ...
        <div className='grid cards-container grid-cols-3 gap-6'>
          {features.map(item => (
            <div
              key={item.title}
              className='about-card bg-white rounded-xl border border-gray-200 p-8 hover:shadow-md transition-shadow'
            >
