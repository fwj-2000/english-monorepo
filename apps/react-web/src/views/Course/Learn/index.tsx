...
export default function Learn() {
  ...
  if (isLoading)
    return <Skeleton active paragraph={{ rows: 10 }} className='max-w-3xl mx-auto p-10' />
    ...
    <div className='max-w-3xl mx-auto py-10 px-6'>
      <div className='mb-6'>
        ...
        <p className='text-sm text-gray-400 mt-1'>
          进度 {currentIndex + 1} / {wordList.length}
        </p>
      </div>
        ...
        <div className='text-center mb-8'>
          ...
          {!isWordBlurred && currentWord && (
            <div className='mt-4 space-y-2'>
              {currentWord.definition && <p className='text-gray-600'>{currentWord.definition}</p>}
