...
export class MinioService implements OnModuleInit {
  ...
  // 注入ConfigService 用于读取环境变量 全部都是minio需要的配置
  ...
  getIsHttps() {
    return !!Number(this.configService.get<string>('MINIO_USE_SSL'));
  }
  getPort() {
    return Number(this.configService.get<string>('MINIO_PORT'));
  }
  getEndpoint() {
